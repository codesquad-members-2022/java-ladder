...
public class Line {
    public final String INVALID_INPUT_PERSON_NUMBER_MESSAGE = "사람수는 1명 이상만 가능합니다.";
    public final String INVALID_INPUT_LADDER_POSITION_MESSAGE = "ladder의 시작 지점은 0 ~ (사람수-1) 까지만 가능합니다.";
    public final String ALREADY_MAKE_LADDER_MESSAGE = "이미 해당지점에 사다리가 생성되어 있습니다.";

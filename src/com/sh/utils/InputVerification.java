...
public class InputVerification {
	...
	public static final String ERROR_WHITE_SPACE = "이름을 입력하세요";
	...
	public static void isValidNames(String inputValues) {
		String[] names = inputValues.split(SYMBOL_NAME_SEPARATOR);
	...
	private static void isValidLengthOfEachNames(String[] names) {
		Arrays.stream(names)
			...
			.findAny()
			.ifPresent(invalid -> {new IllegalArgumentException(ERROR_LENGTH_OF_NAME);});
	}
